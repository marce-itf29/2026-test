...
Cuando un tester o un equipo de pruebas encuentra un defecto en el software, el bug advocacy implica comunicar de manera efectiva la importancia y las implicaciones del error a los desarrolladores y otras partes interesadas en el proyecto.
